...
def testset_output_allCNN():
    ...
    dataprek = np.load(u'.\\data_unimodal_vs_oligomodal_inc_stripmodes_train_trainraw_test_4x4.npz')
    ...
    for kfold in range(N_kfolds):
        filepath = u".\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\saves\\nf1={:d}_nf2={:d}_nf3={:d}_nh1={:d}_lr={:.4f}" \
                   u"\\kfold={:d}\\1\\".format(nf1, nf2, nf3, nh1, lr, kfold)
        # if os.path.isfile(
        #         'D:\\data\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\testres_nf1={:d}_nf2={:d}_nf3={:d}_nh1={:d}_lr={:.4f}'
        #         '_kfold{:d}.npy'.
...
def CM_testset():
    ...
    for kfold in range(10):
        ...
        CM_mat[kfold, 3] = TN
        CM_mat[kfold, 4] = FN
    np.save('D:\\data\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\testset_nf1={:d}_nf2={:d}_nf3={:d}_nh1={:d}_lr={:.4f}'
...
def plot_BA_Volume_UO_vs_CI():
    ...
    nh1 = 1000
    lr = 0.0005
    ConMat = np.load(r'D:\\data\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\testset_nf1={:d}_nf2={:d}_nf3={:d}_nh1={:d}'
    ...
    testPM_nfnh_UO = np.load('.\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\testPM_nfnh_{:d}x{:d}.npy'.format(k, k))
    ...
    ax.minorticks_off()
    plt.legend()
    f.savefig('.\\cnniter_Unimodal_vs_Oligomodal_inc_stripmodes_4x4\\BalAcc_vs_nh_nf20_UO_vs_CI.pdf', facecolor=f.get_facecolor())
    f.savefig('.\\cnniter_Unimodal_vs_Oligomodal_inc_stripmodes_4x4\\BalAcc_vs_nh_nf20_UO_vs_CI.svg', facecolor=f.get_facecolor())
    f.savefig('.\\cnniter_Unimodal_vs_Oligomodal_inc_stripmodes_4x4\\BalAcc_vs_nh_nf20_UO_vs_CI.png', dpi=400, facecolor=f.get_facecolor())
    plt.show()
    plt.close()
    ...
    ax.minorticks_off()
    plt.legend()
    f.savefig('.\\cnniter_Unimodal_vs_Oligomodal_inc_stripmodes_4x4\\Volume_vs_nh_nf20_UO_vs_CI.pdf', facecolor=f.get_facecolor())
    f.savefig('.\\cnniter_Unimodal_vs_Oligomodal_inc_stripmodes_4x4\\Volume_vs_nh_nf20_UO_vs_CI.svg', facecolor=f.get_facecolor())
    f.savefig('.\\cnniter_Unimodal_vs_Oligomodal_inc_stripmodes_4x4\\Volume_vs_nh_nf20_UO_vs_CI.png', dpi=400,
...
def analyse_wrongclassification():
    ...
    #     # start = i*n_lr
    #     outval = np.load(
    #         'D:\\data\\cnn_Unimodal_vs_Oligomodal_big_4x4\\testres_nf1={:d}_nf2={:d}_nf3={:d}_nh1={:d}_lr={:.4f}'
    #             '_kfold{:d}.npy'.
    #             format(nf1, nf2, nf3, nh1, lr, kfold))
    ...
    #
    # np.save('.\\cnn_Unimodal_vs_Oligomodal_big_4x4\\acc_M_kfold.npy', acc_M_kfold)
    # np.save('.\\cnn_Unimodal_vs_Oligomodal_big_4x4\\acc_M_kavg.npy', acc_M_kavg)
    acc_M_kfold = np.load('.\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\acc_M_kfold.npy')
    acc_M_kavg = np.load('.\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\acc_M_kavg.npy')
    ...
    plt.legend()
    f.savefig('.\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\accuracy_saturated_modes_'
...
def test_random_walk_trueclass(k):
    ...
    if not os.path.exists(savedir):
        os.makedirs(savedir)
    # resultstring = u'C:\\Users\\ryanv\\PycharmProjects\\MetaCombiNN\\cnniter_Unimodal_vs_Oligomodal_4x4\\kfold_avg_val_results.txt'
    ...
    batch_size = 5000
    for j, l in enumerate(range(0, 62821, batch_size)):
...
def plot_CM_bestvalloss():
    ...
    resultstring = u'C:\\Users\\ryanv\\PycharmProjects\\MetaCombiNN\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_' \
                   u'4x4\\kfold_val_acc_loss_prec_rec_f1.npz'
    KFres = np.load(resultstring)['val_loss_list']
    bestkfold = np.nanargmin(KFres)

    ConMat = np.load(
        r'D:\\data\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\testset_nf1={:d}_nf2={:d}_nf3={:d}_nh1={:d}'
        r'_lr={:.4f}_TP_FP_TN_FN.npy'.format(nf1, nf2, nf3, nh1, lr))
    ...
    f.savefig('.\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\ConfusionMatrix_bestvalloss.pdf',
              facecolor=f.get_facecolor())
    f.savefig('.\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\ConfusionMatrix_bestvalloss.svg',
              facecolor=f.get_facecolor())
    f.savefig('.\\cnn_Unimodal_vs_Oligomodal_big_inc_stripmodes_4x4\\ConfusionMatrix_bestvalloss.png',
